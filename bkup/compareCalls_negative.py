...
print "The number of common validated negative positions is: "+str(common_count)
print "The number of common validated negative positions (PP=1) is: "+str(c_1)+" total is: "+str(t_c_1)
print "The number of common validated negative positions (PP>0.5) is: "+str(c_p5)+" total is: "+str(t_c_p5)
print "The number of common validated negative positions (PP>0.1) is: "+str(c_p1)+" total is: "+str(t_c_p1)
print "The number of common validated negative positions (PP>0.01) is: "+str(c_p01)+" total is: "+str(t_c_p01)
print "The number of common validated negative positions (PP>0.001) is: "+str(c_p001)+" total is: "+str(t_c_p001)
print "The number of common validated negative positions (PP>0.0001) is: "+str(c_p0001)+" total is: "+str(t_c_p0001)
