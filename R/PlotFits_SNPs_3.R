...
#        ggplot(data = t, aes(x=RA, y=V_A)) + geom_line(aes(col = M)) +scale_x_continuous(limits = c(0,200)) + scale_y_continuous(limits = c(0,500))
        ggplot(data = t, aes(x=RA, y=V_A)) + geom_line(aes(col = M)) + scale_x_continuous(limits = c(0,200)) +scale_y_continuous(limits = c(0,500)) + theme(legend.title = element_blank() ) + xlab("Reference + Alternate allele count") + ylab("Variance of alternate allele count") + coord_fixed(ratio = 0.4)
