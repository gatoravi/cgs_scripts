...
for c in "X":
    ...
    f.write ("GENOTYPE:1"
              ...
              "\nADMIXSNPFILE:/home/comp/exlab/aramu/files/HapMix/AdmixPop_2/aml.chr"+str(c)+".snp"
              "\nADMIXGENOFILE:/home/comp/exlab/aramu/files/HapMix/AdmixPop_2/aml.chr"+str(c)+".eigenstratgeno"
              "\nADMIXINDFILE:/home/comp/exlab/aramu/files/HapMix/AdmixPop_2/aml.chr"+str(c)+".ind"
              "\nREF1LABEL:CEU"
              "\nREF2LABEL:YRI"
              "\nADMIXPOP:AML"
