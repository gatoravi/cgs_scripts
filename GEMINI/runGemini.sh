...
set -e
INPUT_VCF=snvs_indels.vcf.gz
VCFTOOLS_PREFIX=snvs_indels_filteredDP10
VCFTOOLS_VCF=snvs_indels_filteredDP10.recode.vcf
VEP_OUTPUT=snvs_indels_annotated.vcf
VEP_OUTPUT_GZ=snvs_indels_annotated.vcf.gz
